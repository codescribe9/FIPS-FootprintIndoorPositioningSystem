...
class ViewController: UIViewController, MKMapViewDelegate {
    ...
    */
    ...
    override func viewDidLoad() {
        ...
        */
        //left bottom
        let anchor1 = GeoAnchor(latitudeLongitudeCoordinate: CLLocationCoordinate2DMake(33.135864,-96.767394), pdfPoint: CGPoint(x: 75.1, y: 65.4))

        //top right
        let anchor2 = GeoAnchor(latitudeLongitudeCoordinate: CLLocationCoordinate2DMake(33.136893,-96.765994), pdfPoint: CGPoint(x: 528.8, y: 466.8))
        ...
        */
        let pdfTriangleRegionToHighlight = [CGPoint(x: 189, y: 231), CGPoint(x: 147.0, y: 310.0), CGPoint(x: 208.0, y: 304.0)]
        ...
        */
        ...
        let pdfUrl = Bundle.main.url(forResource: "LMS", withExtension: "pdf", subdirectory:"Floorplans")!
